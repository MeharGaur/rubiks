...
CFLAGS = -std=gnu99 -gsource-map --source-map-base /backend/ -s WASM=1 -s ALLOW_MEMORY_GROWTH=1 -s ENVIRONMENT=web -s EXPORTED_FUNCTIONS='["_solve"]' -s EXPORTED_RUNTIME_METHODS='["ccall", "cwrap"]' --preload-file $(SRC_DIR)cache@
# -lidbfs.js
